...
org.crmsolve.ViewForm = function()
{
	...
	{					
		...
		this.div.find('#close').click(function(e){this.closePrompt()}.bind(this));
	  this.div.find('#save').click(function(e){this.save();return false}.bind(this));		
	...
	{										
		...
		{
			// Prompt for save
			org.crmsolve.prompt2('Changes to '+this.entity,
				'Save changes?',
				[{button:'yes',function:function(){this.save()}.bind(this)},
				 {button:'no',function:function(){this.close()}.bind(this)}]
			);
		}
		else this.close();
	}
	...
	this.close = function()
	{
	  ...
	  this.div.children().animate({'opacity':0},100);
		this.div.animate({'left':this.fromLeft,
											'top':this.fromTop,
											'width':20,
											'height':10,
