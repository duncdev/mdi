...
// General	
org.crmsolve.log = org.crmsolve.log || 
	function(msg)
	{
		console.log(msg);
	};
...
org.crmsolve.date = org.crmsolve.date || 
{
	...
	today: function()
	{
		...
		return Date.parse(currentTime.getMonth() + 1 + "/" + currentTime.getDate() + "/" + currentTime.getFullYear());
	},
	    ...
	    buttons: [
	    	{
		   		...
		   		click: function() {
			   		if (typeof(options[0]['function']) === 'function') options[0]['function']();
			   		$(this).dialog('close');
		   		}	
	    	},
	    	{
		   		...
		   		click: function() {
			   		if (typeof(options[1]['function']) === 'function') options[1]['function']();
			   		$(this).dialog('close');
		   		}	
